...
import { initMongoDB } from '../../db/connection.js' /* Cada .. en la ruta significa que subes un nivel en la jerarquía de directorios. 
...
switch (persistence) {
    ...
    break;
    case 'mongo':
        console.log("persistencia es :" + persistence)
        initMongoDB();
