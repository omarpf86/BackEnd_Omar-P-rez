...
export const pushXproductInCart = async (cid, id,cantidad) => {
    try { 
        return await cartDao.pushXproductInCart(cid, id,cantidad) 
    } catch (error) {
        throw new Error(error);
    }
};
...
export const deleteProductInCart = async (cid, id) => {
    try {
        return await cartDao.deleteProductInCart(cid, id)
...
export const deleteAllProductsInCart = async (cid, id) => {
    try {
        return await cartDao.deleteAllProductsInCart(cid, id)
